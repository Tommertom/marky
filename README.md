# Marky - Free Markdown WYSIWYG Editor

A simple, free, and powerful WYSIWYG (What You See Is What You Get) markdown editor that runs entirely in your browser. No installation required, no data sent to servers - everything stays on your device.

## Try It Out

**[Launch Marky Editor](https://marky-md.web.app/)** - Start editing markdown right now!
...
- Perfect for README files, documentation, notes, and more

## For Developers

Found a bug or have a feature request? Please visit our [GitHub Issues page](https://github.com/yourusername/mkd-editor/issues) to report problems or suggest improvements.
